...
const ProfileCard = ({
  ...
  const handlebutton = async (e) => {
    e.preventDefault();
    const response = await axios.post("https://mentor-connect-api.onrender.com/schedule-meet", {
      email,
    });
        ...
        <div className="lowersection bg-zinc-900 text-white p-3 rounded-b-lg">
          ...
          <div className="flex justify-center mt-4 ">
            <HoverBorderGradient
              ...
              className="dark:bg-black text-white text-xl dark:text-white flex items-center space-x-2 border-none  "
            >
